...
public:
    ...
    void getRandomInput()
    {
        ...
        obstacles[0].addPoint({200, 480});
        obstacles[0].addPoint({200, 100});
        obstacles[0].addPoint({250, 100});
        obstacles[0].addPoint({250, 480});
        obstacles[1].addPoint({400, 0});
        obstacles[1].addPoint({300, 100});
        obstacles[1].addPoint({350, 250});
        obstacles[1].addPoint({450, 250});
        obstacles[1].addPoint({500, 100});
