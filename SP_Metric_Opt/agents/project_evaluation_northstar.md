...
-- E3: INCR_Reopt_1 >= INCR_Reopt_5 >= INCR_Reopt_10 >= INCR_Reopt_30 >= INCR_Reopt_60 (per-activation ET non-increasing as the reoptimization period grows); investigation gate for the P1.1 residual, currently FAILs by design (suite stays red until P1.1 resolves).
