...
| **P1.11** Incremental RTA Patching (priority-prefix reuse + per-core cache) | [`active_tasks/P1_11_incremental_rta_patching/`](active_tasks/P1_11_incremental_rta_patching/) | **RESUMED 2026-07-18.** Core cache API implementation (rev-3) complete and tested. Remaining work is to wire the cache into the sub-incremental eval path (seam 3b) and optimize patching in Loop A (priority) and Loop B (TL). |
