    ...
    Throughout this section, we assume that task configurations $\configs$ are fixed.
    Optimization of task configurations will be discussed in the next section.
    ...
    When task configuration parameters are fixed, the performance function in the SP metric~\eqref{eq_sp_def} becomes a constant coefficient.
