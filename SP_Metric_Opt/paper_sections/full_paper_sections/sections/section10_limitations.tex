...
% The "Potential Limitations and Assumption Relaxation" section has been dissolved into
% the main text; this file is retained only as a comment archive.
%   - smooth-environment assumption: removed (described GPR, which the implementation no longer uses)
%   - non-Gaussian ET distribution: covered by the safe-upper-bound framing in the System Model section
%   - incremental optimization drift: moved to the QoS co-optimization section (section_config_opt, label sec: drift)
%   - multi-core (gang) task scheduling: kept below as comments for future reference
