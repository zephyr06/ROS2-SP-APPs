\sen{how to provide hard safety / schedulability guarantee}
- first propose hard schedulability guarantee PA + TL
- The limit the optimization process's search space into that region
