...
\end{figure}
	...
	\begin{equation}
		\max_{\mathcal{A}, \boldsymbol{\mathcal{Q}}}  \textbf{SP}(\mathcal{A}; \textbf{E}_k)
	...
	\end{equation}
        ...
        $C_i^D$ denotes $\tau_i$'s execution time distribution, $\boldsymbol{\mathcal{Q}}$ represents the tasks' QoS budgets.
...
\begin{itemize}
    \item \textbf{Mixed combinatorial and continuous variables:} The problem involves both continuous variables (QoS budgets $\boldsymbol{\mathcal{Q}}$) and combinatorial variables (priority assignments included in $\mathcal{A}$).
...
\end{itemize}
	...
	\begin{itemize}
		\item The performance metric only depends on the QoS budget $\boldsymbol{\mathcal{Q}}$ and is independent of the priority assignments $\mathcal{A}$.
		\item The safety metric depends on both $\boldsymbol{\mathcal{Q}}$ and $\mathcal{A}$.
    ...
    The QoS budgets $\boldsymbol{\mathcal{Q}}$ and priority assignments $\mathcal{A}$ are optimized separately and then combined.
