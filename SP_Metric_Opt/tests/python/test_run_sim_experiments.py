...
class TestRunSimExperiments(unittest.TestCase):
    ...
    def test_analyze_single_instance(self, mock_run):
        ...
        try:
            ...
            sched_ret, miss_rate, sp_values_run, run_intervals_data = analyze_single_instance(
    ...
    def test_write_summary_and_plots(self, mock_savefig):
        ...
        try:
            ...
            self.assertEqual(lines[0].strip(), "Scheduler,Mean_SP_Metric,Std_SP_Metric,Mean_Miss_Rate,Std_Miss_Rate")
