...
int main(int argc, char *argv[]) {
    ...
    program.add_argument("--file_path")
        .default_value(
            std::string("/home/zephyr/Programming/ROS2-SP-APPs/SP_Metric_Opt/"
                        "TaskData/test_robotics_v26.yaml"))
        .help(
    ...
    program.add_argument("--output_file_path")
        .default_value(std::string("TaskData/pa_res_test_robotics_v26.yaml"))
        .help(
